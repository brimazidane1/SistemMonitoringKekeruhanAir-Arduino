...
include('koneksi.php');
include('timbal_hilir_functions.php');
?>
<html>
...
<head>
  ...
  <title>SiMo Sungai Siak | Timbal Hilir</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview  menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="timbal_hilir.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Timbal Hilir</p>
                  </a>
                </li>
      ...
      <section class="content">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <!-- tabel isi -->
            <table id="ttimbal_hilir" class="display" style="width:100%">
              <thead>
                <tr>
                  <th><b>#</b></th>
                  <th><b>PPM</b></th>
                  <th><b>ABS</b></th>
                  <th><b>Actual Conc</b></th>
                  <th><b>Actual Conc Unit</b></th>
                  <th><b>%RSD</b></th>
                  <th><b>Waktu</b></th>
                </tr>
              </thead>
  ...
  <script>
    $(document).ready(function() {
      var dataTable = $('#ttimbal_hilir').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
          url: "timbal_hilir2.php", // json datasource
          ...
          error: function() { // error handling
            $(".ttimbal_hilir-error").html("");
            $("#seng-grid").append('<tbody class="seng-grid-error"><tr><th colspan="3">No data found in the server</th></tr></tbody>');
            $("#ttimbal_hilir_processing").css("display", "none");
          }
        },
        // maped with result array from datatable  
        columns: [{
            "data": "id_timbal_hilir"
          },
          {
            "data": "ppm"
          },
