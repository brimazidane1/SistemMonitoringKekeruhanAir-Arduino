...
include('koneksi.php');
include('seng_hilir_functions.php');
?>
<html>
...
<head>
  ...
  <title>SiMo Sungai Siak | Seng Hilir</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="seng_hilir.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Seng Hilir</p>
                  </a>
                </li>
      ...
      <section class="content">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <!-- tabel isi -->
            <table id="tseng_hilir" class="display" style="width:100%">
              <thead>
                <tr>
                  <th><b>#</b></th>
                  <th><b>PPM</b></th>
  ...
  <script>
    $(document).ready(function() {
      var dataTable = $('#tseng_hilir').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
          url: "seng_hilir2.php", // json datasource
