...
<head>
  ...
  <title>SiMo Sungai Siak | Besi Hilir</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="besi_hilir.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Besi Hilir</p>
                  </a>
                </li>
      ...
      <section class="content">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <!-- tabel isi -->
            <table id="tbesi_hilir" class="display" style="width:100%">
              <thead>
                <tr>
                  <th><b>#</b></th>
                  <th><b>PPM</b></th>
  ...
  <script>
    $(document).ready(function() {
      var dataTable = $('#tbesi_hilir').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
          url: "besi_hilir2.php", // json datasource
