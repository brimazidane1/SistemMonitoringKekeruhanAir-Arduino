...
include('koneksi.php');
include('kekeruhan_hilir_functions.php');
?>
<html>
...
<head>
  ...
  <title>SiMo Sungai Siak | Kekeruhan Hilir</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="kekeruhan_hilir.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Kekeruhan Hilir</p>
                  </a>
                </li>
      ...
      <section class="content">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <table id="tkekeruhan_hilir" class="display" style="width:100%">
              <thead>
                <tr>
                  <th>#</th>
                  <th>Tegangan</th>
  ...
  <script>
    $(document).ready(function() {
      var dataTable = $('#tkekeruhan_hilir').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
          url: "kekeruhan_hilir2.php", // json datasource
