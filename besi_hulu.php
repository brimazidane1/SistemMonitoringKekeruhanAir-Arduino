...
include('koneksi.php');
include('besi_hulu_functions.php');
?>
<html>
...
<head>
  ...
  <title>SiMo Sungai Siak | Besi Hulu</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item ">
                  <a href="besi_hulu.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Besi Hulu</p>
                  </a>
                </li>
      ...
      <section class="content">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <!-- tabel isi -->
            <table id="tbesi_hulu" class="display" style="width:100%">
              <thead>
                <tr>
                  <th><b>#</b></th>
                  <th><b>PPM</b></th>
  ...
  <script>
    $(document).ready(function() {
      var dataTable = $('#tbesi_hulu').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
          url: "besi_hulu2.php", // json datasource
